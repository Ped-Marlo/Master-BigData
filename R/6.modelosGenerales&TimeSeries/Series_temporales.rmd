...
- $\epsilon (t)$ es la componente de error ó ruido blanco de la serie
...
Creamos el dataframe de la predicción de 1961 e incluímos los valores de tendencia resultado de la regresión y los añadimos a la columna de tendencia. Estos años corresponden a los pasos 145 a 156 de la secuencia desde el origen, el valor de la regresión se calcula como
...
Observamos el valor del error hasta 1960 y debería distribuirse entorno a 1 con formato de campana de Gauss (Normal(1, $\epsilon$))
